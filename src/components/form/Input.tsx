...
const defaultClassName = "rounded-lg p-1 font-semibold border-2 text-primary-1 bg-background-100 border-primary-1 dark:border-primary-3 dark:bg-background-950 dark:text-background-100";
